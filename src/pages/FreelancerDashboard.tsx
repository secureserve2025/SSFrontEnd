    ...
    <div className="space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">
                {t('freelancer.welcomeMessage')}
              </h2>
              <p className="text-sm sm:text-base text-gray-300 mb-4">
                {t('freelancer.completeProfile')}
              </p>
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                <div className="flex items-center space-x-2 w-full sm:w-auto">
                  ...
                  <span className="text-sm font-medium text-cyan-400 whitespace-nowrap">
                    {calculateCompletion()}% {t('freelancer.profileCompletion')}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-gray-800 rounded-lg p-4 border border-gray-700 space-y-2 sm:space-y-0">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm sm:text-base text-gray-300">
              {t('dashboard.lastUpdated')}: {lastUpdated.toLocaleDateString()} at {lastUpdated.toLocaleTimeString()}
            </span>
          </div>
          <div className="flex items-center space-x-2">
            <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-400" aria-hidden="true" />
            <span className="text-sm sm:text-base text-green-400 font-medium">{t('dashboard.profileComplete')}</span>
          </div>
        </div>
      )}
      ...
      <div className="bg-gray-800 rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-700">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
          <h2 className="text-xl sm:text-2xl font-bold text-white">{t('dashboard.profileInformation')}</h2>
          {!isEditing && (
            <button
        ...
        <form className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8" noValidate>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="relative">
              <input
                ...
                name="freelancerId"
                type="text"
                value={profileData.freelancerId || t('freelancer.willBeAssigned')}
                disabled
            ...
            <p id="freelancer-id-help" className="text-gray-400 text-xs sm:text-sm mt-1">
              {profileData.freelancerId 
                ? t('freelancer.uniqueId')
                : t('freelancer.autoGenerated')
              }
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder={t('freelancer.enterFullName')}
              disabled={!isEditing}
              required
          ...
          <div>
            ...
            <input
              ...
              tabIndex={-1}
            />
            <p id="email-help" className="text-gray-400 text-xs sm:text-sm mt-1">{t('freelancer.emailCannotChange')}</p>
          </div>

          {/* Mobile Number */}
          <div>
            <label htmlFor="mobile-number" className="block text-gray-300 text-sm font-semibold mb-2">
              {t('freelancer.mobileNumber')} *
            </label>
            <div className="flex space-x-2">
              ...
              <input
                ...
                placeholder={t('freelancer.enterMobile')}
                disabled={!isEditing}
                required
                maxLength={10}
          ...
          <div>
            ...
            <input
              ...
              placeholder={t('freelancer.upiExample')}
              disabled={!isEditing}
              required
          ...
          <div className="min-w-full">
            ...
            <div className="bg-gray-700 rounded-t-lg">
              <div className="grid grid-cols-7 gap-4 p-4 text-sm font-semibold text-gray-300">
                ...
                <div className="text-left">{t('dashboard.clientId')}</div>
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm sm:text-base text-gray-400 max-w-md">
                      {t('freelancer.projectsWillAppear')}
                    </p>
                  </div>
                  <div className="pt-4">
                    <button
                    ...
                    >
                      ...
                      <span>{t('freelancer.completeProfileButton')}</span>
                    </button>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-gray-800 rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-700">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-300">
              {t('freelancer.paymentHistory')}
            </p>
          </div>
          <div className="flex items-center space-x-2 text-sm text-gray-400">
            <CreditCard className="h-4 w-4" aria-hidden="true" />
            <span>₹0 {t('stats.totalEarned')}</span>
          </div>
        </div>
              ...
              <div className="p-8 sm:p-12 text-center">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm sm:text-base text-gray-400 max-w-md">
                      {t('freelancer.transactionHistoryDesc')}
                    </p>
                  </div>
                  <div className="pt-4">
                    <button
                    ...
                    >
                      <Briefcase className="h-4 w-4" aria-hidden="true" />
                      <span>{t('freelancer.viewProjects')}</span>
                    </button>
                  </div>
                </div>
              </div>
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="bg-gray-800 rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-700">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-300">
            {t('freelancer.communicateClients')}
          </p>
        </div>
        ...
        <form className="space-y-6" noValidate>
          ...
          <div>
            ...
            <select
              ...
              required
            >
              <option value="">{t('freelancer.chooseClient')}</option>
      ...
      <div className="bg-gray-800 rounded-2xl p-6 sm:p-8 border border-gray-700 text-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base text-gray-400 max-w-md">
              {t('freelancer.startConversation')}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <span className="text-gray-300 text-sm sm:text-base hidden sm:inline">
                {t('dashboard.welcome')}, {profileData.fullName || t('nav.asFreelancer')}
              </span>
              <button
